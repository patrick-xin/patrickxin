					...
					<div className="">
						<div className="absolute z-20 inline-block rotate-[-2deg]">
							...
							<div className="overflow-hidden">
								<span className="relative block text-primary leading-[8rem]">
									Crafting
								</span>
							</div>
						...
						<div className="relative z-10">
							<div className="relative overflow-hidden text-start ">
								<div className="relative inline-block leading-[8rem] rotate-[-2deg] text-primary">
									Crafting
								</div>{" "}
								<div className="relative leading-[8rem] inline-block bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent">
									Digital
								</div>{" "}
							</div>
							<div className="relative leading-[8rem] overflow-hidden bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-start text-transparent">
